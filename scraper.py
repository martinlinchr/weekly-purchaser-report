...
def scrape_commodity_page(soup):
    ...
    # Instead of looking for a specific table, we'll create a DataFrame from the details
...
def extract_data_from_page(soup):
    ...
    if table:
        ...
        # If we can't find the table, we'll return None instead of an empty DataFrame
        return None
